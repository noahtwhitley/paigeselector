...
const activityOptions = [
    ...
    { name: "Cozy Movie Night", location: "indoor", groupSize: "couple", activityLevel: "relaxed", duration: "medium", description: "We have SO many movies and TV shows we need to watch, so lets start!" },
    { name: "Coffee Shop", location: "indoor", groupSize: ["alone", "couple", "small-group"], activityLevel: "relaxed", duration: "medium", description: "Peace on Earth or finding a new one and pretening to do homework but getting like 0% done is AWESOME" },
    { name: "Thrifting", location: "indoor", groupSize: ["couple", "small-group"], activityLevel: "moderate", duration: "medium", description: "Thrifting with Paige is the dream. Going to Savers and buying things for our future home is my FAV" },
    ...
    { name: "Find a Cutesy Bookstore", location: "indoor", groupSize: ["couple", "alone"], activityLevel: "relaxed", duration: "medium", description: "I already KNOW there are some cute ones around us, and books are so Paige. Maybe we can get you a new Anne of Green Gables" },
    { name: "Painting", location: "indoor", groupSize: ["alone", "couple", "small-group"], activityLevel: "relaxed", duration: "medium", description: "Going to a lookout or park or up the canyon and painting with Paige is AWESOME" },
    ...
    { name: "Photoshoot Shot By Yours Truly", location: "indoor", groupSize: "couple", activityLevel: "relaxed", duration: "medium", description: "Spend an hour figuring out an outfit and then another 1 trying to find somewhere YUUUUP" },
    { name: "Read a Book Bro", location: "indoor", groupSize: ["alone", "couple"], activityLevel: "relaxed", duration: ["short", "medium", "long"], description: "Go to park or just at home and read and have a good drink yay!" },
    ...
    { name: "Sunset Picnic", location: "outdoor", groupSize: "couple", activityLevel: "relaxed", duration: "medium", description: "Flight park or our canyon road and go watch sunset and eat fruit" },
    { name: "Hike to a Waterfall", location: "outdoor", groupSize: ["couple", "small-group"], activityLevel: "active", duration: ["medium", "long"], description: "We are so close to so many cool waterfall hikes. Let's do some research and find an easy cute one" },
    ...
    { name: "Stargazing", location: "outdoor", groupSize: "couple", activityLevel: "relaxed", duration: "medium", description: "The US thing. Go to our park or honestly anywhere with music and us" },
    ...
    { name: "Go Feed Ducks", location: "outdoor", groupSize: "couple", activityLevel: "relaxed", duration: "short", description: "I love ducks and we should go feed them" },
    ...
    { name: "Self-care Night", location: "indoor", groupSize: "alone", activityLevel: "relaxed", duration: "medium", description: "Give yourselve the Paige's Jawsome Spa Treatment. Bathbomb and all the fancy selfcare things you have" },
    ...
    { name: "Solo Coffee Date", location: ["indoor", "outdoor"], groupSize: "alone", activityLevel: "relaxed", duration: "medium", description: "Go get some chai and People-watch or get some homework done" },
    { name: "Create a New Playlist", location: "indoor", groupSize: "alone", activityLevel: "relaxed", duration: ["short", "medium"], description: "Find a mood or feeling or song and make a whole playlist around it! Send it to me after and I'll listen to it" },
    ...
    { name: "Potluck Dinner", location: "indoor", groupSize: ["small-group", "large-group"], activityLevel: "relaxed", duration: "medium", description: "Plan a dinner with friends and make them bring stuff" },
    ...
    { name: "Day at a Lake", location: "outdoor", groupSize: ["small-group", "large-group"], activityLevel: "moderate", duration: "long", description: "Bring drinks and snacks and fun outdoor activites!" },
    { name: "Bowling", location: "indoor", groupSize: ["small-group", "large-group"], activityLevel: "moderate", duration: "medium", description: "Bowling is awesome even if I SUCK. Good activity for double dates and a ton around us." },
    { name: "Backyard Bonfire", location: "outdoor", groupSize: ["small-group", "large-group"], activityLevel: "relaxed", duration: "medium", description: "Get people together and make smore's and just enjoy each other's company" },
    ...
    { name: "Embroidery", location: "indoor", groupSize: ["alone", "couple"], activityLevel: "relaxed", duration: ["medium", "long"], description: "Embroidery is so fun and easy. We can get some blanks and make them projects" },
    ...
    { name: "Go Try New Things From Coffee Shop", location: "indoor", groupSize: ["couple", "small-group"], activityLevel: "relaxed", duration: "short", description: "I feel like there is SO much at coffee shops and we really just get the same stuff every time. Lets switch it up!" },
    { name: "Spend Some Time in Nature", location: "outdoor", groupSize: ["alone", "couple"], activityLevel: "relaxed", duration: "short", description: "Go up the canyon or just find a quiet spot and exist there for a lil" },
