...
const foodOptions = [
    ...
    { name: "Maverik Poppyseed Muffin & Diet Coke", mealType: ["breakfast", "snack/dessert"], cuisine: "american", location: ["takeout", "eat-out"], price: ["budget"], description: "I remember when you put me on this & I haven't been the same since. Diet coke everytime we go into maverik obvi" },
